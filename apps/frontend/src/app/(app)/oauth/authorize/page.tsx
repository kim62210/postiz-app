        ...
        <div className="bg-[#1A1919] rounded-[16px] p-[32px] flex flex-col gap-[24px]">
          ...
          <div className="border-t border-[#2A2929] pt-[16px]">
            ...
            <ul className="text-[14px] list-disc list-inside space-y-[4px]">
              <li>{t('app_scope_integrations', 'Access your integrations and channels')}</li>
              <li>{t('app_scope_posts', 'Create and schedule posts on your behalf')}</li>
              <li>{t('app_scope_analytics', 'Read your post analytics')}</li>
            </ul>
          </div>
